<%-- 
    Document   : update
    Created on : Oct 22, 2022, 7:42:11 PM
    Author     : buing
--%>
        ...
        <div class="wrapper">
            ...
            <div class="content-wrapper">
                <div class="content">
                    ...
                    <div class="container">
                        <form action="<c:url value="/adminbrand/update" />" method="POST" enctype="multipart/form-data">
                        <div class="text-danger">${error}</div>
                        <div class="form-horizontal">
                            <h4>Thương hiệu <b>${brand.getBrandName()}</b></h4>
                            <input style="display: none;" name="BrandID" value="${brand.getID()}" />
                            <hr />
                            <c:if test="${Error != null}">
                                <div class="p-3 mb-2 bg-danger text-white">Có lỗi xảy ra</div>
                            </c:if>
                            <div class="form-group">
                                <label class="control-label col-md-2">Tên thương hiệu</label>
                                <div class="col-md-10">
                                    <input class="form-control" name="BrandName" type="text" value="${brand.getBrandName()}" required />
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="control-label col-md-2">Ảnh thương hiệu</label>
                                <div class="col-md-10">
                                    <input class="form-control" type="file" value="Chọn ảnh ..." accept="image/jpeg, image/jpg, image/png" name="LogoURL" required />
                                </div>
                            </div>
                            <div class="mb-md-3">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-10">
                                    <input class="form-control" name="Describe"  value="${brand.getDescribe()}" type="text" required />
                                </div>
                            </div>
                            <div class="form-group">
