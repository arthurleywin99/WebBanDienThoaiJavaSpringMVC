<%-- 
    Document   : create
    Created on : Oct 22, 2022, 1:56:03 PM
    Author     : buing
--%>
        ...
        <div class="wrapper">
            ...
            <div class="content-wrapper">
                <div class="content">
                    <h2>Create</h2>
                    <div class="container">
                        <form action="<c:url value='/adminproducttype/create' />" method="POST">
                            <div class="form-horizontal">
                                ...
                                <div class="form-group">
                                    <label class="control-label col-md-2">Icon FontAwesome</label>
                                    <div class="col-md-10">
                                        <input class="form-control" name="IconURL" required />
                                    </div>
                                </div>
                                <div class="form-group">
