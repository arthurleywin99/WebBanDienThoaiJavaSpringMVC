<%-- 
    Document   : create
    Created on : Oct 22, 2022, 8:19:40 PM
    Author     : buing
--%>
        ...
        <div class="wrapper">
            ...
            <div class="content-wrapper">
                <div class="content">
                    <h2>Create</h2>
                    <div class="container">
                        <form action="<c:url value="/adminsupplier/create" />" method="POST">
                            <div class="text-danger">${error}</div>
                            <div class="form-horizontal">
                                <h4>Nhà cung cấp mới</h4>
                                <hr />
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-10">
                                        <input class="form-control" name="SupplierName" type="text" required />
                                    </div>
                                </div>
                                <div class="form-group">
