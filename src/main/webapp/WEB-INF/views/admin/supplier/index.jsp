<%-- 
    Document   : index
    Created on : Oct 22, 2022, 8:13:08 PM
    Author     : buing
--%>
            ...
            <div class="content-wrapper">
                <div class="content">
                    ...
                    <div class="container-fluid bg-gray-light">
                        <a href="<c:url value='/adminsupplier/create/index' />" class="btn btn-success text-uppercase mb-md-1">Tạo Mới</a>
                        <table class="table">
                            ...
                            <tbody>
                                ...
                                <c:forEach var="item" items="${supplierList}">
                                    <tr>
                                        ...
                                        <td>
                                            <a href="<c:url value='/adminsupplier/update/index?supplierid=${item.getID()}' />" class="btn btn-warning text-uppercase">Update</a>
                                        </td>
                                    </tr>
                                </c:forEach>
                            </tbody>
