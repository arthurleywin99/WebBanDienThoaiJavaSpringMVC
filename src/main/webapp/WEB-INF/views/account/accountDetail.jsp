<%-- 
    ...
    Created on : Oct 22, 2022, 11:34:47 PM
    Author     : buing
--%>
                    ...
                    <div class="row">
                        <div class="col-md-3 pl-md-3 pt-md-3">
                            <div class="rounded border border-gray" style="border-radius: 15px !important;">
                                <a href="<c:url value='/account/accountdetail' />" class="d-flex rounded border border-danger bg-red_custom text-decoration-none">
                                    <div class="col-md-2">
                                ...
                                <a href="<c:url value='/account/orderhistory' />" class="d-flex text-decoration-none">
                                    <div class="col-md-2">
                        ...
                        <div class="col-md-9 d-flex rounded border border-danger bg-red_custom row" style="border-radius: 10px !important;">
                            <div class="text-center" style="width: 100%;">
                                <h5>Xin chào</h5>
                                <p class="text-uppercase text-danger" style="font-size: 26px;">${account.getFullName()}</p>
                            </div>
                            <div class="row text-center" style="width: 100%;">
                                ...
                                <div class="col-md-2">
                                    ...
                                    <div>
                                        <p class="font-weight-bold" style="font-size: 20px;">${account.getBirthDate()}</p>
                                    </div>
                                </div>
                                <div class="col-md-2">
                                    <h6>Số điện thoại</h6>
                                    ...
                                    <div>
                                        <p class="font-weight-bold" style="font-size: 20px;">${account.getPhoneNumber()}</p>
                                    </div>
                                </div>
                                <div class="col-md-2">
                                    ...
                                    <div>
                                        <p class="font-weight-bold text-uppercase" style="font-size: 20px;">${AccountType}</p>
                                    </div>
                                </div>
                                <div class="col-md-2">
                                    <h6>Ngày tham gia</h6>
                                    ...
                                    <div>
                                        <p class="font-weight-bold text-uppercase" style="font-size: 20px;">${account.getJoinDate()}</p>
                                    </div>
                                </div>
                                <div class="col-md-2">
                                    <h6>Tích luỹ</h6>
                                    ...
                                    <div>
                                        <p class="font-weight-bold" style="font-size: 20px;">
                                            ...
                                            <fmt:formatNumber value="${accumulateMoney}" type="currency" pattern="##,###"  />
                                        </p>
                                    </div>
                                </div>
                                <div class="col-md-1"></div>
