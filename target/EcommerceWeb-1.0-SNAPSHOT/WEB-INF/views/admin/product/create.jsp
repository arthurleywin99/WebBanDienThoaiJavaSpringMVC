<%-- 
    Document   : create
    Created on : Oct 21, 2022, 8:44:41 PM
    Author     : buing
--%>
        ...
        <div class="wrapper">
            ...
            <div class="content-wrapper">
                <div class="content">
                    <h2>Create</h2>
                    <div class="container">
                        <form action="<c:url value="/adminproduct/create" />" method="POST" name="createProduct" enctype="multipart/form-data">
                            ...
                            <div class="form-horizontal">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-10">
                                        <input class="form-control" type="file" value="Chọn ảnh ..." accept="image/jpeg, image/jpg, image/png" name="ImageURL" required />
                                    </div>
                                </div>
                                <div class="mb-md-3">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-10">
                                        <input class="form-control" name="QuantityInStock" value="0" type="number" min="0" required />
                                    </div>
                                </div>
                                <div class="mb-md-3">
