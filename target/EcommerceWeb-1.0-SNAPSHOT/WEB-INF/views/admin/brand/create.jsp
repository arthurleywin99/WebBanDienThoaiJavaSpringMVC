...
<%-- 
    Document   : create
    Created on : Oct 22, 2022, 7:41:55 PM
    Author     : buing
--%>
        ...
        <div class="wrapper">
            ...
            <div class="content-wrapper">
                <div class="content">
                    <h2>Create</h2>
                    <div class="container">
                        <form action="<c:url value="/adminbrand/create" />" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="form-horizontal">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-10">
                                        <input class="form-control" name="Describe" type="text" required />
                                    </div>
                                </div>
                                <div class="form-group">
                                    <div class="col-md-offset-2 col-md-10">
                                        <input type="submit" value="Tạo mới" class="btn btn-outline-primary" />
                                    </div>
                                </div>
                            </div>
                        </form>
