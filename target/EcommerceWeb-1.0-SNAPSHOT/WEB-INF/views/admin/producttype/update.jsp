<%-- 
    Document   : update
    Created on : Oct 22, 2022, 2:12:50 PM
    Author     : buing
--%>
        ...
        <div class="wrapper">
            ...
            <div class="content-wrapper">
                <div class="content">
                    <h2>Update</h2>
                    <div class="container">
                        <form action="<c:url value='/adminproducttype/update' />" method="POST">
                            <div class="form-horizontal">
                                <h4>Loại sản phẩm ${PType.getProductTypeName()}</h4>
                                <hr />
                                <c:if test="${Error != null}">
                                    <div class="p-3 mb-2 bg-danger text-white">Có lỗi xảy ra</div>
                                </c:if>
                                <input style="display: none;" name="ProductTypeID" value="${PType.getID()}" /> 
                                <div class="form-group">
                                    <label class="control-label col-md-2">Tên loại sản phẩm</label>
                                    <div class="col-md-10">
                                        <input class="form-control" name="ProductTypeName" value="${PType.getProductTypeName()}" required />
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="control-label col-md-2">Icon</label>
                                    <div class="col-md-10">
                                        <input class="form-control" name="IconURL" value="${PType.getIconURL()}" required />
                                    </div>
                                </div>
                                <div class="form-group">
