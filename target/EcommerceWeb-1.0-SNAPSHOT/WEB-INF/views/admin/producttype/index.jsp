<%-- 
    Document   : index
    Created on : Oct 22, 2022, 10:21:55 AM
    Author     : buing
--%>
            ...
            <div class="content-wrapper">
                <div class="content">
                    ...
                    <div class="container-fluid bg-gray-light">
                        <a href="<c:url value='/adminproducttype/create/index' />" class="btn btn-success text-uppercase mb-md-1">Tạo Mới</a>
                        <table class="table">
                            ...
                            <tbody>
                                ...
                                <c:forEach var="item" items="${productTypeList}">
                                    <tr>
                                        ...
                                        <td>
                                            <a href="<c:url value='/adminproducttype/update/index?producttypeid=${item.getID()}' />" class="btn btn-warning text-uppercase">Update</a>
                                            <c:choose>
                                                <c:when test="${item.getStatus() == 'TRUE'}">
                                                    <a href="<c:url value='/adminproducttype/disable?producttypeid=${item.getID()}' />" class="btn btn-primary text-uppercase">Selling</a>
                                                </c:when>
                                                <c:otherwise>
                                                    <a href="<c:url value='/adminproducttype/disable?producttypeid=${item.getID()}' />" class="btn btn-danger text-uppercase">Disabled</a>
                                                </c:otherwise>
                                            </c:choose>
                                        </td>
                                    </tr>
